import{Ka as l,La as m,Ma as p,Pa as c,n as s,q as o}from"./chunk-3PESPG7X.js";var g=(()=>{let t=class t{constructor(r,a){this.apollo=r,this.store=a}resolve(r,a){let f=m`
      {
        allAntennas(skip: 0){
          ant_name
          ant_type
