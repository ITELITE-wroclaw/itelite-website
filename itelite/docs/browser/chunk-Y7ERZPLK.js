import{Ja as l,Ka as m,La as p,Oa as c,n as s,q as o}from"./chunk-44JLYKZK.js";var g=(()=>{let t=class t{constructor(r,a){this.apollo=r,this.store=a}resolve(r,a){let f=m`
      {
        allAntennas(skip: 0){
          ant_name
          ant_type
