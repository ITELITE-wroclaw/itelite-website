import{Ia as l,Ja as m,Ka as p,Na as c,n as s,q as o}from"./chunk-ERINIIIF.js";var g=(()=>{let t=class t{constructor(r,a){this.apollo=r,this.store=a}resolve(r,a){let f=m`
      {
        allAntennas(skip: 0){
          ant_name
          ant_type
