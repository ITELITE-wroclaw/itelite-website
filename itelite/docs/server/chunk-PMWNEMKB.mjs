...
import{b as c}from"./chunk-WHQRUKRX.mjs";import{c as l,i as m,j as p}from"./chunk-JTOILZDI.mjs";import{C as s,F as o}from"./chunk-LPQCVQNN.mjs";var g=(()=>{let t=class t{constructor(r,a){this.apollo=r,this.store=a}resolve(r,a){let f=p`
      {
        allAntennas(skip: 0){
          ant_name
          ant_type
