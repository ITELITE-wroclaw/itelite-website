...
import{a as l,d as m,l as p,m as c}from"./chunk-RZUZ6SGS.mjs";import{E as s,H as o}from"./chunk-JQUX54ML.mjs";var g=(()=>{let t=class t{constructor(r,a){this.apollo=r,this.store=a}resolve(r,a){let f=c`
      {
        allAntennas(skip: 0){
          ant_name
          ant_type
