...
import{a as l,d as m,k as p,l as c}from"./chunk-3QC6BO2D.mjs";import{F as s,I as o}from"./chunk-KKYZWTMA.mjs";var g=(()=>{let t=class t{constructor(r,a){this.apollo=r,this.store=a}resolve(r,a){let f=c`
      {
        allAntennas(skip: 0){
          ant_name
          ant_type
