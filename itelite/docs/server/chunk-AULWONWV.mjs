...
import{a as l,d as m,k as p,l as c}from"./chunk-WOE5MALZ.mjs";import{E as s,H as o}from"./chunk-ZL4XGEJS.mjs";var g=(()=>{let t=class t{constructor(r,a){this.apollo=r,this.store=a}resolve(r,a){let f=c`
      {
        allAntennas(skip: 0){
          ant_name
          ant_type
