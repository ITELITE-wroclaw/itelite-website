...
import{b as c}from"./chunk-46LSSSM6.mjs";import{c as l,i as m,j as p}from"./chunk-FNOFWG6I.mjs";import{D as s,G as o}from"./chunk-KOPBLV66.mjs";var g=(()=>{let t=class t{constructor(r,a){this.apollo=r,this.store=a}resolve(r,a){let f=p`
      {
        allAntennas(skip: 0){
          ant_name
          ant_type
