import{Ia as l,Ja as m,Ka as p,Na as c,m as s,p as o}from"./chunk-33JUOB3P.js";var g=(()=>{let t=class t{constructor(r,a){this.apollo=r,this.store=a}resolve(r,a){let f=m`
      {
        allAntennas(skip: 0){
          ant_name
          ant_type
